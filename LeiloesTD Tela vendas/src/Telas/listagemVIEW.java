...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
       String idProduto = id_produto_venda.getText();
        ...
        try {
            ...
            // Chamar o método para vender o produto
    ...
    private void listarProdutos(){
        ProdutosDAO produtosDao = new ProdutosDAO(); // Buscar os dados
            ArrayList<ProdutosDTO> listaProdutos = produtosDao.getProdutos(); // Recuperar os dados
            ...
            for (ProdutosDTO c : listaProdutos) {
                Object[] obj = new Object[]{
                    c.getId(),   // Id
                    c.getNome(),   // Nome do filme
                    c.getValor(),    // Data de lançamento
                    c.getStatus() // Categoria
                };
