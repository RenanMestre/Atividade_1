...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    if (strNome.isEmpty() || strValor.isEmpty()){
        ...
        int valorConvertido = Integer.parseInt(strValor);

        ProdutosDTO produtos = new ProdutosDTO();
        ProdutosDAO dao = new ProdutosDAO();

        produtos.setNome(strNome);
        produtos.setValor(valorConvertido);

        System.out.println("Tentando conectar ao banco de dados...");

        System.out.println("Conexão estabelecida. Tentando salvar...");
        int resposta = dao.salvar(produtos);
